...
abstract class ScanDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(connection: SQLiteConnection) {
                connection.execSQL(
                    "ALTER TABLE pages ADD COLUMN bookReviewResolved INTEGER NOT NULL DEFAULT 0"
                )
            }
        }
        ...
        private val MIGRATION_12_13 = object : Migration(12, 13) {
            override fun migrate(connection: SQLiteConnection) {
                connection.execSQL(
                    "ALTER TABLE pages ADD COLUMN cleanupRecipe TEXT"
                )
            }
        }
        ...
        private val MIGRATION_13_14 = object : Migration(13, 14) {
            override fun migrate(connection: SQLiteConnection) {
                connection.execSQL(
                    "ALTER TABLE pages ADD COLUMN ocrBaseLayout TEXT"
                )
                connection.execSQL(
                    "ALTER TABLE pages ADD COLUMN textEditRecipe TEXT"
                )
            }
        }
        ...
        private val MIGRATION_14_15 = object : Migration(14, 15) {
            override fun migrate(connection: SQLiteConnection) {
                connection.execSQL("ALTER TABLE pages ADD COLUMN markupRecipe TEXT")
            }
        }

        private val MIGRATION_15_16 = object : Migration(15, 16) {
            override fun migrate(connection: SQLiteConnection) {
                connection.execSQL("ALTER TABLE pages ADD COLUMN formFillRecipe TEXT")
                connection.execSQL(
                    """
                ...
                connection.execSQL(
                    "CREATE INDEX IF NOT EXISTS index_form_templates_updatedAt " +
                        "ON form_templates(updatedAt)"
                )
                connection.execSQL(
                    "CREATE UNIQUE INDEX IF NOT EXISTS index_form_templates_normalizedName " +
                        "ON form_templates(normalizedName)"
                )
            }
        }
        ...
        private val MIGRATION_17_18 = object : Migration(17, 18) {
            override fun migrate(connection: SQLiteConnection) {
                connection.execSQL(
                    "ALTER TABLE documents ADD COLUMN publishingRecipe TEXT"
                )
                connection.execSQL(
                    "ALTER TABLE pages ADD COLUMN assemblyMetadata TEXT"
                )
            }
        }
        ...
        private val MIGRATION_19_20 = object : Migration(19, 20) {
            override fun migrate(connection: SQLiteConnection) {
                connection.execSQL(
                    "ALTER TABLE documents ADD COLUMN securityRecipe TEXT"
                )
                connection.execSQL(
                    "ALTER TABLE documents ADD COLUMN integrityManifest TEXT"
                )
            }
        }
        ...
        internal fun migrationEdgesForTest(): List<Pair<Int, Int>> =
            ALL_MIGRATIONS.map { migration ->
